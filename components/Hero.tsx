...
const Hero: React.FC<HeroProps> = ({ onCtaClick }) => {
  return (
    <section className="relative pt-32 md:pt-40 pb-24 md:pb-32 overflow-hidden mesh-bg">
      {/* Background Dots */}
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-20 text-center">
        ...
        <h1 className="text-4xl md:text-8xl font-extrabold text-slate-900 tracking-tight mb-6 relative z-10">
          One platform. <br />
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-[12%] left-[-2rem] sm:left-4 lg:left-20 w-44 sm:w-56 p-4 sm:p-5 bg-white shadow-xl rounded-2xl border border-slate-100 transform -rotate-3 floating-element delay-1 scale-[0.5] sm:scale-75 lg:scale-100 opacity-10 sm:opacity-40 lg:opacity-50">
        ...
        <div className="absolute top-[18%] right-[-6rem] sm:right-4 lg:right-20 w-64 sm:w-80 bg-white/95 backdrop-blur-xl shadow-2xl rounded-2xl sm:rounded-3xl p-5 sm:p-7 border border-slate-50 floating-element delay-1 scale-[0.35] sm:scale-75 lg:scale-100 opacity-10 sm:opacity-35 lg:opacity-45 origin-top-right">
