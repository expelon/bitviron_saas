...
const FeatureSection: React.FC = () => {
  return (
    <section className="bg-white py-32 overflow-hidden relative">
      ...
      >
        <source src="/animated-3d-video.mp4" type="video/mp4" />
      </video>

      {/* Background Overlay - adjusted for more visibility */}
      <div className="absolute inset-0 bg-white/20 backdrop-blur-[1px] z-[1]"></div>

      <div className="max-w-7xl mx-auto px-6">

        <h2 className="text-[60px] md:text-[240px] font-black text-slate-900 leading-[0.85] tracking-tighter mb-16 opacity-[0.05] absolute top-12 left-6 pointer-events-none uppercase">
          BITVIRON.
        </h2>

        <div className="relative z-10">
          <h2 className="text-[50px] md:text-[180px] font-black text-slate-900 leading-[0.8] tracking-tighter mb-20 uppercase">
            BITVIRON.
          </h2>
          ...
          <div className="grid md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-4 flex justify-center order-1 md:order-2">
              {/* Removed abstract shape and button for video clarity */}
            </div>


            <div className="md:col-span-4 flex flex-col gap-6 md:items-end md:text-right order-3 items-start text-left">
